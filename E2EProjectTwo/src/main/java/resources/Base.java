...
public class Base {
	...
	public WebDriver initialiseDriver() throws IOException { 
		...
		prop = new Properties();
		prop.load(fis);
		//String browser = prop.getProperty("browser"); // pulls property from data.properties file
		String browser = System.getProperty("browser"); // pulls property from system properties (which is being populated by jenkins via maven)
